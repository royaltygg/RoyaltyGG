...
### **Crypto**
To deposit, you will need to connect your wallet via our wallet providers. Once connected, you'll be able to deposit any amount to our smart contract. [Check supported cryptocurrencies here](/deposit-methods/crypto)

<Info>
All deposits incur a fee to maintain the platform, be sure to check out the [fees](/fees-loyalty/buyer-fees) page to understand the fee structure.
</Info>

<Frame>
  <img className="block dark:hidden rounded-md" src="/images/howitworks1.png" />
  <img className="hidden dark:block rounded-md" src="/images/howitworks1.png" />
</Frame>
<br></br>
<Warning>
...
Once you have successfully deposited, your balance will show up after `15` confirmations, and you will be ready to convert to your Buff balance!

## **3.** Convert your funds into Buff
...
<Frame>
  <img className="block dark:hidden rounded-md" src="/images/howitworks3.png" />
  <img className="hidden dark:block rounded-md" src="/images/howitworks3.png" />
</Frame>

Once the conversion is complete, your balance will be updated and you can proceed to deposit more!

<Frame>
  <img className="block dark:hidden rounded-md" src="/images/howitworks4.png" />
  <img className="hidden dark:block rounded-md" src="/images/howitworks4.png" />
</Frame>
<br></br>

<Check>
Congratulations! You have now successfully converted your crypto into your Buff account.
</Check>
